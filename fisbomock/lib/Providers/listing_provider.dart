...
class ListingProvider with ChangeNotifier {
  ...
  void getNewPhotoLeft(id) {
    Listing listing = findById(id);
    index--;

    if (index < 0) {
      index = photoCount(id) - 1;
    }
    activeUrl = listing.photos[index].url;
      ...
      "listings-list": [
        ...
        },
        {
          ...
          "listing-description": {
            ...
            "description-body":
                "This fabulous innovative three bedroom, two bathroom 2010 build home is perfectly sited for you to enjoy sun, privacy and the peace and quiet of Otonga Heights. Here is a home to tick all the boxes for contemporary living: open plan living with wonderful indoor/outdoor flow to sunny decks and gardens, stylish well appointed kitchen, spacious bathrooms, full insulation and double glazing throughout, family sized heat pump for Winter coziness. Large double garage with auto door plus off-street parking for two completes the picture.",
            "features": [
              {
